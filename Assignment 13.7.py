...
# Make sure to check that your code is using the API endpoint as shown
# above. You will get different results from the geojson and json
...
address = "Rochester Institute of Technology"#input('Enter location: ')
